...
from .database import guardar_cliente, buscar_cliente_por_dni, buscar_clientes_por_nombre, eliminar_cliente, obtener_todos_clientes, actualizar_cliente


def registrar_cliente(datos):
    """Le pide a la base de datos que registre a un nuevo cliente."""
    return guardar_cliente(datos)
